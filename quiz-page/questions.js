export let globalCategories = {
  history: [
    [
      ...
      {
        "What year did Columbus first sail to America?": {
          1492: true,
          1500: false,
          1600: false,
          1400: false,
      ...
      },
      {
        ...
        explanation:
          "The Eiffel Tower is located in France, in the city of Paris.",
      },
      {
      ...
      },
      {
        ...
        explanation: "Italy is famous for its pasta and pizza.",
      },
      {
  ...
  science: [
    [
      ...
      {
        "What gas do plants need to perform photosynthesis?": {
          "Carbon Dioxide": true,
          Oxygen: false,
          Nitrogen: false,
          Hydrogen: false,
    ...
    [
      ...
      },
      {
        ...
        explanation:
          "The Big Bang Theory explains the origin of the universe as a rapid expansion from a singular point about 13.8 billion years ago.",
      },
      {
      ...
      },
      {
        ...
        explanation:
          "The Earth's core is primarily composed of iron, with smaller amounts of nickel and other elements.",
      },
      {
        "In quantum mechanics, what is the name of the principle that states that certain pairs of physical properties cannot be simultaneously known to arbitrary precision?":
          {
            "Heisenberg Uncertainty Principle": true,
            "Pauli Exclusion Principle": false,
            "Schrödinger Equation": false,
            "Dirac Equation": false,
          },
        explanation:
          "The Heisenberg Uncertainty Principle states that certain pairs of physical properties, like position and momentum, cannot be known with arbitrary precision simultaneously.",
      },
      {
        "What is the name of the hypothetical particle that is believed to mediate the force of gravity in quantum field theory?":
          {
            Graviton: true,
            Photon: false,
            Gluon: false,
        ...
        explanation:
          "The graviton is the hypothetical quantum particle believed to mediate the force of gravity in quantum field theory.",
      },
      {
        "Which scientist is known for developing the theory of general relativity?":
          {
      ...
      {
        "What is the term for the study of the properties and behavior of subatomic particles?":
          {
        ...
        explanation:
          "Particle physics is the study of the properties and behavior of subatomic particles, often referred to as high-energy physics.",
      },
      {
        "What is the name of the phenomenon where light bends around a massive object due to the curvature of spacetime?":
          {
            "Gravitational Lensing": true,
            "Doppler Effect": false,
            "Photoelectric Effect": false,
            "Compton Scattering": false,
          },
        explanation:
          "Gravitational lensing is the phenomenon where light bends around a massive object due to the curvature of spacetime.",
      },
      {
        "What is the name of the chemical reaction that involves the breaking down of glucose to produce ATP in the presence of oxygen?":
          {
  ...
  entretainment: [
    ...
    [
      {
        "In which movie does the character Jack Sparrow appear?": {
  ...
  culture: [
    [
      ...
      {
        "What is the name of the famous Egyptian river?": {
          Nile: true,
          Amazon: false,
          Mississippi: false,
          Yangtze: false,
